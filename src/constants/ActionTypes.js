...
export const ON_ORDER_SELECT = 'on_order_select';
export const ON_ADD_ORDER = 'on_add_order';
export const ON_ORDER_CLOSE = 'on_order_close';
export const ON_SAVE_ORDER = 'on_save_order';
export const ON_DELETE_ORDER = 'on_delete_order';
export const ON_DELETE_SELECTED_ORDER = 'on_delete_selected_order';
export const FILTER_ORDER = 'filter_order';
export const GET_ALL_ORDER = 'get_all_order';
export const GET_UNSELECTED_ALL_ORDER = 'get_unselected_all_order';
export const ON_ALL_ORDER_SELECT = 'on_all_order_select';
export const HIDE_ORDER_LOADER = 'hide_order_loader';